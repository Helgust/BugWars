...
bool onScreen(GameObject* obj, Point tankPos, Point screenSize)
{
	Point from = tankPos-screenSize/2;
	Point to = tankPos + screenSize/2;
...
void Game::OnUpdate(float dt)
{
	...
	for (auto obj : objects)
	{
		...
		if (!onScreen(obj,tank->position,framework->screenSize))
		{
